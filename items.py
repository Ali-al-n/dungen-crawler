...
dagger = Equipment(
    ...
    rarity=2,
    slot=ItemSlot.WEAPON,
    description="A short pointy Dagger",
)
sword = Equipment(
    name="Sword",
    AP=5,
...
sword_2 = Equipment(
    ...
    rarity=14,
    slot=ItemSlot.WEAPON,
    description="A very very Heavy Sword",
)
sword_3 = Equipment(
    name="Short Sword",
    AP=6,
    ...
    rarity=5,
    slot=ItemSlot.WEAPON,
    description="A short and fast Sword",
)
...
goblin_droptable = potion + [dagger, club, helmet]
dwarf_droptable = potion + [helmet, armor, shield]
orc_droptable = potion + weapons + [armor]
snake_droptable = []
dog_droptable = snake_droptable


# put boss items here
#

dragon_sword = Equipment(
    name="Dragon Slayer Sword",
    AP=10,
    DP=1,
    rarity=15,
    slot=ItemSlot.WEAPON,
    description="A destructive lightning sword",
)
